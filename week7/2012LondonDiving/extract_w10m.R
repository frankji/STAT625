...
m3m <- grep("Women's 10m Platform", myfile, perl = TRUE)
Event <- 'W10mPF'
...
judge.info <- scan(file = 'W10mPF_judges.txt', what = character(), sep = '\n')
...
write.table(judges, file = 'W10mPF_judges.csv', sep = ',', row.names = FALSE)
###########################################################################

Judges <- read.csv('W10mPF_judges.csv', as.is = TRUE)
sink("W10mPF_divers.txt")
...
m3m.info <- scan(file = 'W10mPF_divers.txt', what = character(), sep = '\n')
...
m3m.info <- scan(file = 'W10mPF.txt', what = character(), sep = '\n')
...
write.table(finaltab, file = 'W10mPF.csv', sep = ',', row.names = FALSE)